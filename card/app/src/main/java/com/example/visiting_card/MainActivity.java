...
public class MainActivity extends AppCompatActivity {
    ...
    private void openGitHubUserPage() {
        String url = "https://github.com/samia-jucse"; // Replace with your GitHub URL
    ...
    protected void sendEmail() {
        ...
        String[] TO = {"samiajucse@gmail.com"};
    ...
    private void makePhoneCall() {
        ...
        callIntent.setData(Uri.parse("tel:01308428174"));
    ...
    private void openFacebookPage() {
        String facebookUrl = "https://www.facebook.com/profile.php?id=100045369679455&mibextid=ZbWKwL"; // Replace with your Facebook URL
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(facebookUrl));
        startActivity(browserIntent);
    }

    private void openLinkedinPage() {
        String linkedinUrl = "https://www.linkedin.com/in/samia-alam-a99435276/"; // Replace with your LinkedIn URL
